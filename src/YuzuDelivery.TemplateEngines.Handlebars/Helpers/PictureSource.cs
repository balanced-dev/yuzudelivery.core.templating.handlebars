...
public class PictureSource
{
    ...
    public static Dictionary<string, object> Extend(Dictionary<string, object> obj, Dictionary<string, object> src)
    {
    ...
    public static Dictionary<string, object> ObjectClone(Dictionary<string, object> src)
    {
        return new Dictionary<string, object>(src);
    }

    // Filter all default settings from parameters
    public static Dictionary<string, object> GetImageProcessorSettings(Dictionary<string, object> obj)
    {
    ...
    public static string CreateImageQueryString(Dictionary<string, object> settings)
    {
        var queryString = "?";
    ...
    public static string CreateSourceTag(string mediaCondition, string imageSrc, Dictionary<string, object> settings, string tagClose)
    {
